    ...
    public static void main(String[] args) throws SQLException {
        ...
        */
        ...
        if (selectGenres(connection).size() == 0) {
            ...
            insertEntry(connection, "Country", "http://www.clipartbest.com/cliparts/xig/oj6/xigoj67pT.png", "Blake Shelton", "http://4.bp.blogspot.com/-cM9MCL7OakE/UoDs23VcihI/AAAAAAAAOVI/OLlY-Agy4hw/s1600/promo_big_img.png", "Bring Back the Sunshine", "http://www.josepvinaixa.com/blog/wp-content/uploads/2014/08/Blake-Shelton-Bringing-Back-the-Sunshine-2014-1100x1100.png");
